	...
	if($opr=="del")
{
	...
	if($del_sql)
		echo "<h3 style='color:#e01f3c'>ቦታ ማስያዝ ተሰርዟል ...! </h3>";
	else
...
<table width="755">
	<tr>
        ...
        <td style="float:right">
        	<input type="submit" name="btnsearch" value="ፈልግ" id="button-search" title="ቦታ ማስያዣ ይፈልጉ" />
        </td>
    </tr>
</table>
</form>
...
<form method="post">
    ...
    ?>
      <tr bgcolor="<?php echo $color?>">
            ...
            <td><a rel="facebox" href=editstatusA.php?rs_id=<?php echo $row['id'];?> title="አስተካክል"><img src="picture/update.png" /></a></td>
            <td><a href="?tag=view_reservationA&opr=del&rs_id=<?php echo $row['id'];?>" title="አጥፋ"><img src="picture/delete.png" /></a></td>
