...
<table width="755">
	<tr>
    	<td  width="190px" style="font-size:18px; color:#006; text-indent:30px;"><b><i class="fa fa-database" aria-hidden="true"></i>&nbsp;View Archive form</b></td>
    </tr>
</table>
</form>
...
$sql2=mysqli_query($conn,"select * from  archive_school_form where wcode='$wcode'");
