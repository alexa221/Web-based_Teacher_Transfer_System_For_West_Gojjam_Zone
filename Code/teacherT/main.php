...
<div id="admin">
        ...
        <div id="lmain">
                ...
                <div id="leftmanu">
                    ...
                    <div>
                    <a href="main.php?tag=view_profile" class="customer" title="print report"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;view profile</a>
                    </div>
                    <!--<div>
                    	<a href="main.php?tag=printing" class="customer" title="print report">&nbsp;Print Report</a>
                    </div>-->
					<div>
                    	<a href="main.php?tag=chpass" class="customer" title="change pass"><i class="fa fa-key" aria-hidden="true"></i>&nbsp;Change Password</a>
                    </div>
                </div><!-- end of leftmanu -->
        </div><!--end of lmaim -->
    ...
    <div id="rmain" >
		...
		<td>
		<h3 align="left" style="color:black">WELCOME TO TEACHER SITE</h3>
		</td>
		</tr>
		</table>
             </div><!--end of pic_manu -->
         ...
         <div id="menu2">
                ...
                <li id="li_menu"><a href="#">Transfer Form<span style="font-size: 10px;">&#9660;</span></a>
                    <ul>
                        <li id="li_submenu">
                        <a href="main.php?tag=fill_transfer form" class="sales">School to School</a></li>
						<a href="main.php?tag=fill_transfer form_closed" class="sales"></a>
                        <li id="li_submenu">
						<a href="main.php?tag=fill_transfer_ form_w" class="stocks">Woreda To Woreda</a></li>
	
                    </ul>
                </li>
				
                <li id="li_menu"><a href="#?tag=view_form">view fill form</a>
                  <ul>
                        <li id="li_submenu">
                        <a href="main.php?tag=view_form" class="sales">School to School</a></li>
                        <li id="li_submenu">
						<a href="main.php?tag=view_form_w" class="stocks">Woreda To Woreda</a></li>
               ...
               <li id="li_menu"><a href="#?tag=view_result">View Result&#9660;</a>
			      <ul>
                   ...
                   <a href="main.php?tag=view_result" class="sales">School to School</a></li>
					<a href="main.php?tag=fill_transfer form_closed" class="sales"></a>
                   <li id="li_submenu">
					<a href="main.php?tag=view_result_W" class="stocks">Woreda To Woreda</a></li>
                    </ul>
                </li> 
            ...
            <div id="contents">
				...
				<?php
   						...
   						if($tag=="home" or $tag=="")
                            ...
                            elseif($tag=="fill_transfer form")
                            include("fill_transfer form.php");
							
							elseif($tag=="fill_transfer form_closed")
                            include("fill_transfer form_closed.php");
							elseif($tag=="fill_transfer_ form_w")
                            include("fill_transfer_ form_w.php");
                            ...
                            elseif($tag=="view_form_w")
                            include("view_form_w.php");
