	...
	<form method="post" >
    	...
    	<table border="0" cellpadding="4" cellspacing="0">
        	<tr>
            	<td>Side No:</td>
            	<td>
                	<input type="text" name="side" id="textbox" value="<?php echo $rs_upd['sideno'];?>"/>
                </td>
            </tr>
            ...
            <tr>
            	<td>No OF Seats:</td>
            	<td>
                	<input type="text" name="seat" id="textbox" value="<?php echo $rs_upd['nofseat'];?>"/>
                </td>
            </tr>
...
<div id="top_style">
        <div id="top_style_text">
       <b> <i class="fa fa-plus" aria-hidden="true"></i> School Registration Form</b>
	   <i class="fa fa-plus" aria-hidden="true"></i>
        </div><!-- end of top_style_text-->
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_bus"><input type="button" name="btn_view" title="View Busea" value="View_School" id="button_view" style="width:120px;"  /></a>
    ...
    <div>
   	  <table id="school_R" border="0" cellpadding="4" cellspacing="1" width="420px" >
        	<tr>
            	...
            	<td>
                <input type="text" name="side" id="textbox" style="color: blue" required="required"/>
                </td>
            </tr>
            
            <tr>
            	<td style="color: green;"><b>School Name:</b></td>
            	<td>
                	<input type="text" name="seat" id="textbox" style="color: blue" required="required"/>
                </td>
            </tr>
            
                      <tr>
            	<td style="color: green;"><b>School Level:</b></td>
            	<td>
                	<input type="text" name="seat" id="textbox" style="color: blue" required="required"/>
                </td>
            </tr>
			  <tr>
            	<td style="color: green;"><b>Woreda Code:</b></td>
            	<td>
                	<input type="text" name="seat" id="textbox" style="color: blue" required="required"/>
                </td>
            </tr>
			 <tr>
            	<td style="color: green;"><b>Rank:</b></td>
            	<td>
                	<input type="text" name="seat" id="textbox" style="color: blue" required="required"/>
                </td>
            </tr>
