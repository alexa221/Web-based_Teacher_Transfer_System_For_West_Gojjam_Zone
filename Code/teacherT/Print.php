...
<p align="center"><strong>Contacts AA:</strong>+251939434343 +251948434343 +92511588387<br>
<strong>Contacts Gondar:</strong> +251948535353<br>
<br<strong><strong>Email:</strong>info@goldenbusethiopia.com</p>
	...
	if($key !="")
		$sql_sel=mysql_query("SELECT * FROM reservation where status  like '%$key%'");
		 ...
		 $sql_sel=mysql_query("SELECT * FROM reservation where status = ' on travel'or status='Cancelled'or status='arrived'");
