...
*/
 ...
 if($y<'1'){	
	echo "<ft>soory your service year is less than one year </ft>";
	echo'<meta content="3;main.php?fill_transferform" http-equiv="refresh" />';
	}
	else{
$deletpriv1=mysqli_query($conn,"DELETE from transfer_form WHERE trid ='$tid'");
	...
	<form method="post" >
    	...
    	<table border="0" cellpadding="4" cellspacing="0">
		   ...
		   <option value="<?php echo $rs_upd['first_choice'];?>"><?php echo $rs_upd['first_choice'];?></option>
		       <?php
				$school="SELECT *FROM school where wcode='$woreda'";
...
?>
		<td>
	    <input style="color: blue;width:100px" type="hidden" readonly name="tid" id="textbox" value="<?php echo $u_id;?>"/>  
		 </td>
           </tr>
       <tr>	
	   <?php
...
$row3=mysqli_fetch_array($school);
$schname=$row3['sname'];
...
$finaleservice=$service;
     ...
     <td style="color: black;width:150px;text-align:right"><b>First Name:</b></td>
		...
		<option selected="selected" value="">Select school</option>
				<?php
				$school="SELECT *FROM school where wcode='$wcode' and sid!='$sch'";
				$recored=mysqli_query($conn,$school);
		         if($recored)
				 {
				?>
		      ...
		      {
				  ?>
			 <option id="woreda" value="<?php echo $row['sid'];?>">
		    <?php echo $row["sname"];?>
		     </option>
			 <?php
				 }
		...
		<input style="color: blue;width:100px" type="text" readonly name="age" id="textbox" value="<?php echo $Age;?>"/>  	  
		  ...
		  <td style="color: black;border-left:2px dashed green;border-bottom:2px dashed green;padding-left:13px"><b>Third Choice:</b></td>
            	<td>
				<select  name="tchoice" style="color:blue;border-bottom:2px dashed green;border-right:2px  dashed green;width:200px;height:25px" id="third" onchange="getThirdValue()" class="wcode" required>
				 <option selected="selected" value="">Select school</option>
				<?php
				$school="SELECT *FROM school where wcode='$wcode' and sid!='$sch'";
				$recored=mysqli_query($conn,$school);
	   ...
	   <input style="color: blue;width:120px" type="text" readonly name="major" id="textbox" value="<?php echo $major;?>"/>	  
		  ...
		  <td> 
      <input style="color: blue;width:120px" type="text" readonly name="woreda" id="textbox" value="<?php echo $wcode;?>"/>		  
		    </td> 
		   </tr>
		   	<tr>
		   <td style="color: black;width:150px;text-align:right"><b>School:</b></td> 
		  <td> 
		  <input style="color: blue;width:120px" type="text" readonly name="school" id="textbox" value="<?php echo $schname;?>"/>		   
		   </td> 
		   </tr>
		  <tr>
