...
<div class="modal-header">
		<center><font  class="" id="inde_admin_signup">የይለፍ ቃል ለውጥ ቅጽ</font></center>
    </div>
...
if (isset($_POST['change_password'])) 
	...
	echo '<div class="alert alert-dismissable alert-error"><strong>';
		die("የይለፍ ቃልዎ ከተጠቃሚ ስምዎ ጋር አንድ መሆን የለበትም ፣ ሌላ የይለፍ ቃል ይሞክሩ");
	echo'<meta content="5;mainA.php?tag=chpassA" http-equiv="refresh" />';
		echo '</strong></div>';
	}
		...
		echo '<font color="red" size="3">'."በተሳካ ሁኔታ ተለውጧል!&nbsp;&nbsp;".'<font style="background-color:#fff;" color="#000" size="3">'."&nbsp;".$new_password."&nbsp;".'</font>'."&nbsp;&nbsp;አዲሱ የይለፍ ቃልዎ ነው".'<br>'.'</font>';
...
<div id="style_informations">			 
	...
	<tr>
			...
			<td>
                	<input type="text" style="color: blue" name="username"  title="እባክዎ ትክክለኛ ስም ያስገቡ." id="textbox" pattern="[ሀ-ፐ ]{2,10}" required="required"/>
                </td>
            </tr>
			<tr>
			<td style="color: black;"><b>የአሁኑ ሚስጥራዊ ማለፊያ ቁልፍ</b></td>
			<td>
                	<input type="password" style="color: blue" name="priv_password"  title="እባክዎ ትክክለኛ ስም ያስገቡ." id="textbox" required="required"/>
                </td>
            </tr>
			<tr>
			<td style="color: black;"><b>አዲስ የይለፍ ቃል</b></td>
			<td>
                	<input type="text" style="color: blue" name="new_password"  title="እባክዎ ትክክለኛ ስም ያስገቡ." id="textbox" required="required"/>
                </td>
            </tr>
			<tr>
			<td style="color: black;"><b>የይለፍ ቃል አረጋግጥ</b></td>
			<td>
                	<input type="password" style="color: blue" name="compsswd"  title="እባክዎ ትክክለኛ ስም ያስገቡ." id="textbox" required="required"/>
                </td>
            </tr>
<tr>
                <td colspan="2">
