...
<div id="style_informations">
	<form method="post" >
    	...
    	<table border="0" cellpadding="4" cellspacing="0">
        	<tr>
            	<td style="color: green"><b>መነሻ ከተማ:</b></td>
            	<td>
            ...
            <tr>
            	<td style="color: green"><b>መድረሻ ከተማ:</b></td>
            	<td>
            ...
            <tr>
            	<td style="color: green"><b>ታልጋ ቁጥር:</b></td>
                <td>
...
<div id="style_informations">
    ...
    <div>
   	  <table border="0" cellpadding="4" cellspacing="0">
            ...
            <option value="">Select መነሻ ከተማ</option>			
            <option value="Addis-Ababa">አዲስ አበባ</option>
	    <option value="Bahir-Dar">ባህርዳር</option>
	    <option value="Dessie">ደሴ</option>			
            <option value="Diredawa">ድሬዳዋ</option>
            <option value="Gondor">ደብረታቦር</option>
            <option value="Harar">ሃረር</option>			
            <option value="Hawassa">ሃዋሳ</option>			
            <option value="Jimma">ጅማ</option>
            <option value="Mekelle">መቀሌ</option>
            ...
            <option value="">Select መድረሻ ከተማ</option>			
            <option value="Addis-Ababa">አዲስ አበባ</option>
	    <option value="Bahir-Dar">ባህርዳር</option>
	    <option value="Dessie">ደሴ</option>			
            <option value="Diredawa">ድሬዳዋ</option>
            <option value="Gondor">ጎንደር</option>
            <option value="Harar">ሃረር</option>			
            <option value="Hawassa">ሃዋሳ</option>			
            <option value="Jimma">ጅማ</option>
            <option value="Mekelle">መቀሌ</option>
