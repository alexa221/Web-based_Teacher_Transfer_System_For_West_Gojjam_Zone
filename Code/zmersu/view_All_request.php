...
$id=$row1['u_id'];
$wcode=$row1['wcode'];
$sql_sel=mysqli_query($conn,"SELECT * FROM w_request_table");
    $i=0;
    ...
    ?>
      <tr bgcolor="<?php echo $color?>">
            ...
            <td><a href="?tag=send_request&opr=upd&rs_id=<?php echo $row['Wrid'];?>" title="Update"><img src="picture/update.png" /></a></td>
            <td><a href="?tag=view_request&opr=del&rs_id=<?php echo $row['Wrid'];?>" title="Delete"><img src="picture/delete.png" /></a></td>
        </tr>
    <?php	
    }
