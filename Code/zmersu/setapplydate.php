...
if($sql_ins==true)
{
	...
	echo'<meta content="2;main.php?setapplydate.php" http-equiv="refresh" />';
}	
else
echo "Teachers  Apply Date and time is not setted sucessfully";	
}
else
echo("<i><b>Teachers Apply Date is already setted!!!</b></i>");	
echo'<meta content="2;main.php?setapplydate.php" http-equiv="refresh" />';
}
    ...
    <div>
   	  <table id="school_R" border="0" cellpadding="4" cellspacing="1" width="480px" >
        	<tr>
            	...
            	<td>
               <input type="hidden" name="opendate" id="textbox2" style="color: blue;width:200px;height:25px" value="<?php echo $today;?>"/>
                </td>
            </tr>
            ...
            <tr>
            	...
            	<td>
                	<input type="date" name="closedate" id="textbox1" style="color: blue;width:200px;height:25px" required="required"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
...
<script src="js/jquery-latest.min.js"></script>
		<script>
            ...
            document.getElementsByName("textbox1")[0].min = today2;		
		</script>
</body>
</html>