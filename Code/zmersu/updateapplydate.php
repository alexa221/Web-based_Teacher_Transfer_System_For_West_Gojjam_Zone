...
<p> <b>&#x2730;Update Teacher Apply Date</b></p>
	<?php			
...
echo"<tr><td colspan='2' style='padding-left:29px'><input type='submit' value='Update' name='Update' id='btn'/>&nbsp;<input type='reset'
			 value='Reset'id='btn'/></td></tr></table></form>";
					 ...
					 if(isset($_POST["Update"]))
						...
						//$sdate=$_POST['sdate'];
						$edate=$_POST['edate'];
						$updated=mysqli_query($conn,"update apply_date set EndDate='$edate'");
										if($updated==true){
										echo " Teacher fill form Date Is updated successfully!";
									   echo'<meta content="2;main.php?updateapplydate" http-equiv="refresh" />';
										}
										 else
