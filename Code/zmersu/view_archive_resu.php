...
<table width="755">
	<tr>
    <td  width="270px" style="font-size:18px; color:#006; text-indent:30px;"><b><i class="fa fa-database" aria-hidden="true"></i>&nbsp;View Archive result</b></td>
   <td> 
<input type="button" value="Print" id="button-search" class="btn" onclick="PrintDoc()"/>
</td>
        <td>
...
$key="";
	...
	if($key !="")
	$sql2=mysqli_query($conn,"SElECT * FROM archive_result WHERE Fname  like '%$key%' or Lname like '%$key%'");
	else
$sql2=mysqli_query($conn,"select * from archive_result");
