...
<table width="755">
	<tr>
		...
		<td><input type="text" name="searchtxt" title="ለፍለጋ ስም ያስገቡ " class="search" autocomplete="off"/></td>
        <td style="float:right"><input type="submit" name="btnsearch" value="ፈልግ" id="button-search" title="Search Package" /></td>
    </tr>
</table>
</form>
